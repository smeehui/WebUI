    ...
    const app = {
        ...
        handleEvents: function () {
            ...
            aud.onplay = function () {
                ...
                thumb.style.animation = `${
                    dur / 2
                }s linear 0s 1 normal none spin`;
            ...
            prevPage.onclick = () => {
                ...
                if (app.page < 1) {
                    app.page = Math.ceil(
                        app.songs.length / app.elementsPerPage,
                    );
                }
                app.pagination();
                if (app.searchSongs) {
            ...
            grid.onclick = (e) => {
                const index = Number(
                    e.target.closest(".song-card").dataset.index,
                );
            ...
            rectPlayed.onclick = (e) => {
                const songId = Number(
                    e.target.closest(".rect-song").dataset.id,
                );
        ...
        playSuffle: () => {
            ...
            let newPage = Math.ceil(
                (app.currentIndex + 1) / app.pagedSongs.length,
            );
            if (app.page != newPage) {
                app.page = newPage;
                app.pagination();
